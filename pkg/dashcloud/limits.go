...
func init() {
	...
	limitExplanations[limitKey{dash.AccTypeAnon, "HtmlSizeMB", ""}] = "Anonymous Dashborg accounts have a limit on HTML size.  Register your account for free enable a larger HTML size"
	...
	limitExplanations[limitKey{dash.AccTypeFree, "HtmlSizeMB", ""}] = "Free Dashborg accounts have a limit on HTML size.  Upgrade to a PRO account for a larger HTML limit"
